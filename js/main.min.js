...
function setLabelPlace(){
    let fields = document.querySelectorAll(".fg-dynamic input,.fg-dynamic textarea")
...
let nav = document.querySelector('.product-categories__items')
...
$(".product-categories__item").click(function () {
    $(".product-categories__item").removeClass("_active")
    $(this).addClass("_active")
    setActiveTabVisible()
})
...
function setActiveTabVisible() {
    ...
    console.log(nav)
    if (nav) {
        let navLinks = document.querySelectorAll('.product-categories__item')
        let activeLink = document.querySelector('.product-categories__item._active')
...
$(".header-catalog__show").click(function () {
    $(".header-catalog").toggleClass("_open")
})

$(document).mouseup( function(e){
    let div = $( ".header-contacts,.header-catalog" );
    if ( !div.is(e.target)
...
function Sliders() {
    ...
    function updateEdgeClasses(swiper, slider) {
        const el = swiper.el;
...
function gallery() {
    ...
    sliders.forEach((slider,index) => {
        ...
        gallery.mySwiper = new Swiper(`.gallery[data-slider-id="${index}"] .mySwiper`, {
            ...
            navigation: {
                nextEl: `.gallery[data-slider-id="${index}"] .gallery__small .swiper-button-next`,
                prevEl: `.gallery[data-slider-id="${index}"] .gallery__small .swiper-button-prev`,
            },
            breakpoints: {
                320: {
        ...
        $(`.gallery[data-slider-id="${index}"] .mySwiper .swiper-slide`).click(function () {
            let id = +$(this).attr("data-tab")
            gallery.mySwiper.slideTo(id)
        })
        gallery.mySwiper2 = new Swiper(`.gallery[data-slider-id="${index}"] .mySwiper2`, {
            spaceBetween: 0,
            direction: "vertical",
            navigation: {
                nextEl: `.gallery[data-slider-id="${index}"] .gallery__big .swiper-button-next`,
                prevEl: `.gallery[data-slider-id="${index}"] .gallery__big .swiper-button-prev`,
            },
            thumbs: {
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    $('input[type="tel"]').mask('+375 (99) 999 - 99 - 99', { autoclear: false }, { placeholder: '+375 (  )     -    -   ' });
